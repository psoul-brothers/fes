    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like', models.ManyToManyField(related_name='like', to='persol_users.PersolUser', verbose_name=b'\xe3\x81\x84\xe3\x81\x84\xe3\x81\xad')),
                ('members', models.ManyToManyField(to='persol_users.PersolUser')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
